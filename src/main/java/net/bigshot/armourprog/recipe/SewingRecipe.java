...
public class SewingRecipe implements Recipe<Container> {
    ...
    public SewingRecipe(ResourceLocation id, Ingredient baseItem, Ingredient dye,
                        Ingredient padding, Ingredient embellish, ItemStack result) {
        this.id = id;
    ...
    public RecipeType<?> getType() {
        return ModRecipeTypes.SEWING_TYPE.get();
    }
}
